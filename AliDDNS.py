...
accessKeyId = "LTAI5tGifQ9jXwpwv48DHmmM"  # 将accessKeyId改成自己的accessKeyId
accessSecret = "nFyS6EOHVe3ipZQZLOtprIceYbkLoP"  # 将accessSecret改成自己的accessSecret
domain = "burrymon.gq"  # 你的主域名
name_ipv4 = "blog"  # 要进行ipv4 ddns解析的子域名
name_ipv6 = "remote"  # 要进行ipv6 ddns解析的子域名
